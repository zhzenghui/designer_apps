...
class SoftwaresControllerTest < ActionController::TestCase
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post :create, software: { app_id: @software.app_id, app_name: @software.app_name, app_spell: @software.app_spell }
    end
  ...
  test "should update software" do
    patch :update, id: @software, software: { app_id: @software.app_id, app_name: @software.app_name, app_spell: @software.app_spell }
    assert_redirected_to software_path(assigns(:software))
  end
